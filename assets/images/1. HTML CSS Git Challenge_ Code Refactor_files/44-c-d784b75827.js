...
return e.split(/,\s*</).map(_).filter(o).reduce(d,{})}},"4uX5":function(e,n,t){"use strict"
t.d(n,"a",(function(){return s}))
var a=t("q1tI")
var r=t.n(a)
class s extends r.a.Component{constructor(...e){super(...e)
this.state={hasError:false,error:null}}static getDerivedStateFromError(e){return{hasError:true,error:e}}componentDidCatch(e,n){console.error(e,n)}render(){if(this.state.hasError){var e
return r.a.cloneElement(this.props.errorComponent,{errorSubject:null===(e=this.state.error)||void 0===e?void 0:e.message})}return this.props.children}}},BrAc:function(e,n,t){"use strict"
var a=t("vDqi")
var r=t.n(a)
...
const b=Object(c["lazy"])(()=>Promise.all([t.e(5),t.e(8),t.e(11),t.e(15),t.e(130),t.e(4128)]).then(t.bind(null,"dpkT")))
...
const y=Object(i["lazy"])(()=>Promise.all([t.e(5),t.e(8),t.e(11),t.e(4087)]).then(t.bind(null,"pdP4")))
...
function z(){C([])
E(null)}function L(e){k.find(n=>n.id===e.id)||C(k.concat([e]))}function I(e){C(k.filter(n=>n.id!==e.id))}function T(){return Object(v["a"])({method:"POST",path:"/api/v1/users/self/content_shares",body:Object(r["a"])(Object(r["a"])({},n),{},{receiver_ids:k.map(e=>e.id)})})}function B(){E("info")
T().then(R).catch(e=>{console.error(e)
e.response&&console.error(e.response)
E("error")})}function R(){Object(p["d"])(_.t("Content share started successfully"))()
d.onDismiss()}function w(){return l.a.createElement(l.a.Fragment,null,Object(a["a"])(u["a"],{onClick:d.onDismiss},void 0,_.t("Cancel")),Object(a["a"])(u["a"],{disabled:0===k.length||"info"===x,variant:"primary",margin:"0 0 0 x-small",onClick:B},void 0,_.t("Send")))}const F=Object(a["a"])(h["a"],{as:"div",textAlign:"center"},void 0,Object(a["a"])(g["a"],{renderTitle:_.t("Loading")}))
if(d.open!==A.current){A.current=d.open
z()}let q=""
"info"===x?q=_.t("Starting content share"):"error"===x&&(q=_.t("Error starting content share"))
const H=q?Object(a["a"])(b["a"],{variant:x},void 0,Object(a["a"])("div",{role:"alert","aria-live":"assertive","aria-atomic":true},void 0,q),"info"===x?Object(a["a"])(g["a"],{renderTitle:q,size:"x-small"}):null):null
return l.a.createElement(f["a"],Object.assign({label:_.t("Send To..."),size:"medium"},d,{footer:Object(a["a"])(w,{})}),Object(a["a"])(i["Suspense"],{fallback:F},void 0,H,Object(a["a"])(y,{courseId:t,selectedUsers:k,onUserSelected:L,onUserRemoved:I})))}},U6jy:function(e,n){e.exports=a
...
//# sourceMappingURL=44-c-d784b75827.js.map