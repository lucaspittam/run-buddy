(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[3676,155,4072],{"5nFh":function(e,t,a){"use strict"
...
const M=l.a.shape,L=l.a.arrayOf,P=l.a.string,G=l.a.number
M({course_id:G,name:P,title:P,grading_scheme:P,grading_type:P.isRequired,points_possible:G.isRequired,submission_types:L(P)})
const J=l.a.shape,R=l.a.number
J({range:R,student:R})
...
const Ge={init:(e,t)=>{const a=window.ENV
...
c.loadInitialData()
return l}}}
t["default"]=Ge},CyXg:function(e,t,a){"use strict"
...
const t=document.getElementById("immersive_reader_mobile_mount_point");(e||t)&&a.e(164).then(a.bind(null,"AZYJ")).then(a=>{var n
const s=()=>{var e
...
const L=Promise.all([a.e(9),a.e(70),a.e(3632)]).then(a.bind(null,"fY8A"))
...
r()(".al-trigger").focus()}}),document.getElementById("direct-share-mount-point"))}function G(e,t=true){e&&e.preventDefault()
_.a.render(Object(n["a"])(B["a"],{open:t,sourceCourseId:ENV.COURSE_ID,contentSelection:{assignments:[ENV.ASSIGNMENT_ID]},onDismiss:()=>{G(null,false)
r()(".al-trigger").focus()}}),document.getElementById("direct-share-mount-point"))}r()(()=>{r()(".direct-share-send-to-menu-item").click(P)
r()(".direct-share-copy-to-menu-item").click(G)})
...
//# sourceMappingURL=assignment_show-c-1f806dde74.js.map